...
if ($space['profilestatus']=='0'&&$space['namestatus']=='0'){
		showmessage('enter_the_space', 'space.php?do=business', 0);
	}
	if($space['namestatus']=='0'&&$space['alreadyreg']=='0'){
		showmessage('enter_the_space', './template/default/post_ok.htm', 0);
	}
	if($space['profilestatus']=='0'&&$space['namestatus']=='1'&&empty($space['cheak'])){
...
//$b = array_sum($a);
if(empty($cp_mode)) include_once template("space_businessfeed");
