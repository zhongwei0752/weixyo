<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/cp_magic|template/green/header|template/green/footer', '1377363412', 'template/green/cp_magic');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
