<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/showmessage|template/green/header|template/green/footer', '1377377642', 'template/green/showmessage');?><?php $_TPL['nosidebar']=1; ?>
