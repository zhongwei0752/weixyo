<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/network|template/green/header|template/green/footer', '1377408774', 'template/green/network');?><?php $_TPL['nosidebar']=1; ?>
