<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/green/do_ajax|template/green/header|template/green/space_comment_li|template/green/space_post_li|template/green/space_share_li|template/green/footer', '1377366658', 'template/green/do_ajax');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
