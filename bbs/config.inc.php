...
define('UC_DBNAME', 'gdmc');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`gdmc`.uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', 'p8S0Z0B2tcgcAbN2J6L3r10cC1J8YaZdtedeO8Xee3x2G6V40ev5n4i0z2M4y8oa');
define('UC_API', 'http://localhost/upload/ucenter');
